...
.epos-page .epos-filter-header {
    ...
    padding:clamp(0.75rem, 2vw, 1.5rem) 14px;
}
...
.epos-page .onlineStore {
    padding-top:var(--epos-content-gap) !important;
}
...
.offcanvas-backdrop{
  z-index: 19999 !important;
        ...
        <div class="epos-filter-header navbar navbar-white filter">
            ...
            <button class="navbar-toggler border-0 text-black position-absolute end-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEpos" aria-controls="offcanvasEpos" aria-label="Toggle navigation">
