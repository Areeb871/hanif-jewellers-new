...
<style>
.rado-page {
    --rado-section-space:clamp(2.5rem, 5vw, 4.5rem);
    --rado-content-gap:clamp(1.25rem, 2.5vw, 2rem);
}

.rado-page .rado-products-section {
    padding:0 0 var(--rado-section-space) !important;
}

.rado-page .rado-filter-header {
    display:flex;
...
.rado-page .rado-filter-header .brand-logo-wrapper {
    width:100% !important;
    /* margin:0 !important; */
}

.rado-page .rado-filter-header .brand-logo {
    width:clamp(120px, 28vw, 190px);
    height:auto;
    margin:0 auto !important;
}

.rado-page .rado-filter-header .navbar-toggler {
...
.rado-page .onlineStore {
    padding-top:16px !important;
}

.rado-page .rado-footer {
    padding-top:var(--rado-section-space) !important;
...
<main class="rado-page">
    ...
    <section class="rado-products-section">
        <style>
...
.offcanvas-backdrop{
  z-index: 19999 !important;
       ...
       <div class="rado-filter-header navbar navbar-white filter">
        ...
        <div class="filter d-flex justify-content-end px-3">
            <button class="navbar-toggler border-0 text-black" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRado" aria-controls="offcanvasRado" aria-label="Toggle navigation" style="position:static!important; margin:0!important;">
