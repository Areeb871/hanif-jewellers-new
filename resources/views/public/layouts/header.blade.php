...
<link href="https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700;900&family=Montserrat:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        /* Ensure Bootstrap active backgrounds are transparent within header */
        header .navbar {
        ...
        header .navbar .navbar-nav .nav-link[href*="solitaire"]:link,
        ...
        header .navbar .navbar-nav .nav-link[href*="solitaire"].active,
        header .navbar .navbar-nav .nav-link[href*="solitaire"].show {
            background-color: transparent !important;
            color: #000 !important; /* force desired text color */
            -webkit-text-fill-color: #000 !important; /* iOS Safari */
            outline: none !important;
            box-shadow: none !important;
            text-decoration: none !important;
        }
        /* Specifically target ONLINE SHOPPING STORE link across all states */
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"],
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:hover,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:link,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:visited,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:focus,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:focus-visible,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"]:active,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"].active,
        header .navbar .navbar-nav .nav-link[href*="online-shopping-store"].show {
            background-color: transparent !important;
            color: #000 !important;
        ...
        /* Specifically target WATCHES link across all states */
        header .navbar .navbar-nav .nav-link[href*="watches"],
        header .navbar .navbar-nav .nav-link[href*="watches"]:hover,
        header .navbar .navbar-nav .nav-link[href*="watches"]:link,
        header .navbar .navbar-nav .nav-link[href*="watches"]:visited,
        header .navbar .navbar-nav .nav-link[href*="watches"]:focus,
        header .navbar .navbar-nav .nav-link[href*="watches"]:focus-visible,
        header .navbar .navbar-nav .nav-link[href*="watches"]:active,
        header .navbar .navbar-nav .nav-link[href*="watches"].active,
        header .navbar .navbar-nav .nav-link[href*="watches"].show {
            background-color: transparent !important;
            color: #000 !important;
            -webkit-text-fill-color: #000 !important;
            outline: none !important;
        ...
        /* Absolute fallback: ensure no anchor in header can get a blue background */
        header a,
        header a:link,
        header a:visited,
        header a:hover,
        ...
        /* Prevent blue text selection highlight within header links */
        ...
        /* Force these links to be white ONLY when header is not hovered */
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:link,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:visited,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:hover,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:focus,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:focus-visible,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link:active,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link.show,
        header:not(:hover) nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link.active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"],
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:link,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:visited,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:hover,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:focus,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:focus-visible,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"]:active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"].show,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"].active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"],
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:link,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:visited,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:hover,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:focus,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:focus-visible,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"]:active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"].show,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"].active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"],
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:link,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:visited,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:hover,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:focus,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:focus-visible,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"]:active,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"].show,
        header:not(:hover) nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"].active {
            color: #fff !important;
        ...
        /* Keep navbar background transparent on hover but turn texts/icons black */
        header .navbar { background-color: transparent !important; }
        header .navbar:hover { background-color: transparent !important; }

        /* On hovering anywhere on the navbar, make all nav links black */
        header:hover nav .navbar-nav > li.nav-item > a.nav-link,
        header:hover nav .navbar-nav > li.nav-item.dropdown.position-static > a.nav-link,
        header:hover nav .navbar-nav > li.nav-item > a.nav-link[href*="solitaire"],
        header:hover nav .navbar-nav > li.nav-item > a.nav-link[href*="online-shopping-store"],
        header:hover nav .navbar-nav > li.nav-item > a.nav-link[href*="watches"] {
            color: #000 !important;
            -webkit-text-fill-color: #000 !important;
            background-color: transparent !important;
        }

        /* Brand and header icons also become black on navbar hover */
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="px-md-0 px-3">
                ...
                <div class="row pt-3 desktopLogos">
                    ...
                    <div class="text-center col">
                        <a class="navbar-brand" href="/">
                            <img class="HanifLogoWhite img-fluid" src="{{ asset('assets/f_assets/image/logo.png') }}" alt="Hanif Jewellers" width="200" height="60" loading="eager">
                            <img class="HanifLogoBlack img-fluid" src="{{ asset('assets/f_assets/image/HanifLogoBlack.png') }}" alt="Hanif Logo Black" width="200" height="60" loading="eager">
                        </a>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg px-md-3 pt-3 pb-0">
                <a class="navbar-brand mobileLogo" href="/">
                    <img class="HanifLogoWhite img-fluid" src="{{ asset('assets/f_assets/image/logo.png') }}"
                        alt="Hanif Jewellers">
                    <img class="HanifLogoBlack img-fluid" src="{{ asset('assets/f_assets/image/HanifLogoBlack.png') }}"
                        alt="Hanif Logo Black">
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-header">
                        <img class="offcanvas-title" id="offcanvasNavbarLabel" src="{{ asset('assets/f_assets/image/HanifLogoBlack.png') }}" alt="Hanif Jewellers" width="200" height="60" loading="eager">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav flex-grow-1">
                            <!-- <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="#">HIGH END JEWELLERY</a>
                            </li> -->
                            <li class="nav-item dropdown position-static">
                                <a class="nav-link dropdown-toggle d-flex align-items-center pb-4" href="#"
                                    ...
                                    <!-- <span class="d-sm-none show_sub"><i class="zmdi zmdi-plus-square"></i></span> -->
                                </a>
                                @php
                                    ...
                                    <div class="container-fluid py-4">
                                        <div class="row py-5">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <!-- Tab Content -->
                                                <div class="tab-content py-5 px-3" id="collectionTabsContent">
                                                    @php
                                                        $tabCollections = [
												'HIGH_END' => [
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const renderResults = (term = '') => {
                ...
                const matches = searchData
                    .filter(item => {
                        ...
                        // Prefer name; fall back to slug only if name is missing
            ...
            // Helper to initialize swiper for the currently active tab (used on return/show)
            function initActiveTabSwiper() {
                var activeBtn = document.querySelector('#collectionTabs .nav-link.active');
                if (!activeBtn) return;
                var key = activeBtn.id ? activeBtn.id.replace('tab-', '') : null;
                if (!key) return;
                setTimeout(function(){
                    initSwiper(key);
                    setTimeout(function(){
            ...
            // Re-initialize when returning via back/forward cache
            window.addEventListener('pageshow', function (e) {
                var nav = (performance.getEntriesByType && performance.getEntriesByType('navigation')[0]) || null;
                var isBFCache = e.persisted || (nav && nav.type === 'back_forward');
                if (isBFCache) {
                    initActiveTabSwiper();
                }
            });

            // Re-initialize when the Collections dropdown (mega menu) is opened
            var collectionsDropdown = document.querySelector('li.nav-item.dropdown.position-static');
            if (collectionsDropdown) {
                // Bootstrap event (if used)
                collectionsDropdown.addEventListener('shown.bs.dropdown', function(){
                    initActiveTabSwiper();
                });
                // Hover-based open (custom): hook mouseenter to re-init after menu becomes visible
                collectionsDropdown.addEventListener('mouseenter', function(){
                    setTimeout(initActiveTabSwiper, 80);
                });
            }

            // MutationObserver: detect when mega menu becomes visible, then init swiper
            var megaMenu = document.querySelector('.dropdown-menu.mega-menu');
            if (megaMenu && window.MutationObserver) {
                var observer = new MutationObserver(function(){
                    var isVisible = megaMenu.offsetParent !== null || (megaMenu.getBoundingClientRect().width > 0 && megaMenu.getBoundingClientRect().height > 0);
                    if (isVisible) {
                        setTimeout(initActiveTabSwiper, 80);
                    }
                });
                observer.observe(megaMenu, { attributes: true, attributeFilter: ['class', 'style'] });
            }
