...
<div class="my-5">
    ...
    <section class="py-5">
        <div class="">
            ...
            @php
$recommendedProducts = \App\Models\Products::where('category_id', $product->category_id)
                ...
                <div class="scroller-dots mt-3">
                    <div class="dots-container">
                        @php
                            ...
                            $productsPerView = 4;
                            $totalDots = max(0, $totalProducts - $productsPerView + 1);
                        @endphp
                        @for ($i = 0; $i < $totalDots; $i++)
                            <div class="dot {{ $i === 0 ? 'active' : '' }}" data-index="{{ $i + $productsPerView - 1 }}"></div>
                        @endfor
                    </div>
                </div>
            </section>
