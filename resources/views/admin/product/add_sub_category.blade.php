    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Add Sub Category</h1>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                <form id="sub_category_form" class="form d-flex flex-column flex-lg-row" action="{{route('create-update-sub-category')}}" method="post" enctype="multipart/form-data">
                    @csrf
                                            ...
                                            <div class="fv-row mb-2">
                                                ...
                                                <style>.image-input-placeholder-gallery { background-image: url({{asset('assets/media/svg/files/blank-image.svg')}}); } [data-bs-theme="dark"] .image-input-placeholder-gallery { background-image: url({{asset("assets/media/svg/files/blank-image-dark.svg")}}); }</style>
                                                    ...
                                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Add files">
                                                        ...
                                                        <input type="file" name="uploaded_files[]" id="uploaded_files" accept="image/png, image/gif, image/jpeg , image/webp" multiple />
                                                    </label>
...
<script>
    ...
    document.getElementById('sub_category_form').addEventListener('submit', function() {
