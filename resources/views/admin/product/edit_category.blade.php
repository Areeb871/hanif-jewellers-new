                ...
                <form id="category_form" class="form d-flex flex-column flex-lg-row" action="{{route('create-update-category')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    <option></option>
                                    <option value="active" {{ $category['status'] == 'active' ? 'selected' : '' }}>Published</option>
                                    <option value="inactive" {{ $category['status'] == 'inactive' ? 'selected' : '' }}>Unpublished</option>
                                </select>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <style>.image-input-placeholder-1 { background-image: url({{asset($category['image'])}}); } [data-bs-theme="dark"] .image-input-placeholder-1 { background-image: url({{asset($category['image'])}}); }</style>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="banner_type" id="banner_image_option" value="image" {{ $category['banner_type'] == 'image' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="banner_image_option">Banner Image</label>
                                </div>
                                <div class="form-check form-check-inline pt-2">
                                    <input class="form-check-input" type="radio" name="banner_type" id="banner_video_option" value="video"  {{ $category['banner_type'] == 'video' ? 'checked' : '' }}>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <style>.image-input-placeholder { background-image: url({{asset('assets/media/svg/files/blank-image.svg')}}); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url({{asset("assets/media/svg/files/blank-image-dark.svg")}}); }</style>
                                ...
                                <video id="banner_video_preview" width="150" height="150" controls style="{{$category['banner_type'] == 'image' ? 'display: none' : ''}}">
                                    <source src="{{ $category['banner_type'] == 'video' ? asset($category['banner_url']) : '' }}" type="video/mp4">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                            <style>.image-input-placeholder-2 { background-image: url({{asset($category['banner_type'] == 'image' ? $category['banner_url'] : 'assets/media/svg/files/blank-image.svg')}}); } [data-bs-theme="dark"] .image-input-placeholder-2 { background-image: url({{asset($category['banner_type'] == 'image' ? $category['banner_url'] : 'assets/media/svg/files/blank-image-dark.svg')}}); }</style>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div>
                                    ...
                                    <div id="kt_ecommerce_add_category_description" name="description" class="min-h-200px mb-2">{!! $category['description'] !!}</div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="meta_description" class="form-control mb-2" placeholder="Meta tag description" rows="10">{{$category['meta_description']}}</textarea>
                                </div>
                                <div>
                                    <label class="form-label">Meta Tag Keywords</label>
                                    <input id="kt_ecommerce_add_category_meta_keywords" name="meta_keywords" class="form-control mb-2" value="{{$category['meta_keywords']}}" />
