            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Sub Categories</h1>
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <li class="breadcrumb-item text-muted">Sub Categoreis</li>
                        </ul>
                    </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Sub Category" />
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <a href="/admin/product/add-sub-category" class="btn btn-primary">Add Sub Category</a>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">Sub Category Status</th>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <span class="text-muted fs-7 fw-bold">{{ $category->category->name }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                <a href="{{ route('edit-product-sub-category', $category['id']) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                        <div class="menu-item px-3">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteCategoryModalLabel{{ $category['id'] }}">Are you sure you want to delete this sub category?</h5>
                                        ...
                                        <form id="delete-category-form-{{ $category['id'] }}" action="{{ route('delete-product-sub-category', $category['id']) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('GET')
                                        </form>
                                    </td>
