                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="" style="padding: 0px 75px 60px 0px;margin: -50px;">
                                            <div class="form-check form-switch form-check-custom form-check-solid" style="float: right;">
                                                <input class="form-check-input" type="checkbox" name="is_featured" id="show_pricing" value="1" {{ $product->is_featured ? 'checked' : '' }}/>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="name" class="form-control mb-2" placeholder="Product name" value="{{ $product->name }}" required/>
